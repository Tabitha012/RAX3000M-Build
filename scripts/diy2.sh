...
# 🕒 修改批次：v12.0 终极全自动满血版 (双重死锁自启 + 完美亮灯)
...
# 2. 🌟 OpenClash 大佬级优化 (Aethersailor 奥义)
if [ -f /etc/config/openclash ]; then
    ...
    # 国内DNS强制踢给SmartDNS处理，无 Fallback 远端防泄漏
